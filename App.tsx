...
`;
  ...
  const handleExcelExport = () => {
      ...
      // Export
      window.XLSX.writeFile(wb, "QuantEngine_Report.xlsx");
        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-4 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <div className="w-8 h-8 bg-black rounded-sm flex items-center justify-center shadow-none">
                 <div className="text-white font-serif font-bold text-lg pb-1">Q</div>
            </div>
            <span className={`font-serif font-bold text-lg tracking-wide ${scrolled ? 'text-black' : 'text-black'}`}>
              QUANT<span className="font-light text-stone-500">ENGINE</span>
            </span>
          </div>
